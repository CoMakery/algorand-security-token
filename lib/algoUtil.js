...
exports.transfer = async (client, senderAccount, receiverAccountAddress, amountInMicroAlgos) => {
    ...
    //     "to": receiverAccountAddress.toString(),
    //     "fee": 1000,
...
exports.grantRoles = async function grantRoles(
    ...
    await this.appCall(client, senderAccount, appId, appArgs, [targetAccount.addr])
}
...
exports.mint = async function mint(
    ...
    await this.appCall(client, senderAccount, appId, appArgs, [receiverAccount.addr])
}
